...
import ProfileIcon from "../icons/PFPIcon.tsx";
      ...
      <div className="left-controls">
        ...
        {includeLibraryButton && (
          <button
            ...
            title="Library"
          >
            <LibraryIcon color={theme === "dark" ? "white" : "black"} size={32} />
          </button>
        )}
      </div>

      <h1 className="title" onClick={() => navigate("/")}>SPOTIFYHUB</h1>

      <div className="profile-icon" title="Profile">
        <ProfileIcon  fill="black" color={theme === "dark" ? "white" : "black"}/>
      </div>
    </div>
  );
}